...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "There was an issue sending the reset link. Please try again.",
        variant: "destructive"
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-md">
        ...
        <div className="mt-8 bg-white shadow-sm rounded-lg p-6">
          ...
          <div className="mt-6 text-center">
            <Link to="/login" className="text-sm font-medium text-theme-purple hover:text-theme-purple/80">
              Back to login
            </Link>
          </div>
        </div>
